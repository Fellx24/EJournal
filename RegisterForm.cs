...
namespace EJournal
{
    public partial class RegisterForm : Form
    {
        ...
        private void RegisterButton_Click(object sender, EventArgs e)
        {
            ...
            {
                query.InsertQuery($"\"Users\"(Surname, Name, Fathername, password, email, date)", $"{SurnameTB.Text},{NameTB.Text},{FathernameTB.Text},{PasswordTB.Text}, \'{EmailTB.Text}\', \'{BirthdayTB.Text}\'" , conn);
